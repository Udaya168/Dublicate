...
export function QuickEditResultScreen() {
    ...
    return (
        ...
        >
            ...
            <header className="h-16 flex-none border-b border-white/10 flex items-center justify-between px-4 sm:px-6 bg-black/20 backdrop-blur-3xl z-20">
                ...
                <div className="flex items-center gap-3">
                    <button className="px-3 sm:px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-[11px] font-bold text-slate-300 hover:bg-white/10 flex items-center gap-2">
            ...
            <main className="flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden relative z-10">
                ...
                {/* Left Export Specs */}
                <aside className="w-full md:w-80 flex-none border-b md:border-b-0 md:border-r border-white/10 bg-[#0B1020]/40 backdrop-blur-3xl p-4 sm:p-6 md:p-8 flex flex-col gap-8 md:overflow-y-auto">
                    <div className="space-y-4">
                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Quick Metrics</label>
                        <div className="grid grid-cols-3 gap-3 md:flex md:flex-col md:gap-0 md:space-y-3">
                            {[
                                ...
                                <div key={detail.label} className="p-3 rounded-xl bg-white/5 border border-white/10 flex items-center gap-3">
                                    <detail.icon className="w-4 h-4 text-purple-400 flex-none" />
                                    <div className="flex flex-col">
                ...
                {/* Center Dashboard */}
                <section className="flex-1 p-4 sm:p-6 md:p-12 flex flex-col gap-8 bg-black/10 md:overflow-y-auto">
                    ...
                    <div className="relative flex-1 min-h-[400px]">
                        ...
                        <div className="absolute inset-0 border border-white/10 rounded-2xl bg-[#0B1020] flex flex-col overflow-hidden shadow-2xl">
                            ...
                            {/* Download Bar */}
                            <div className="h-auto sm:h-20 py-4 sm:py-0 bg-[#1a1b2e]/60 backdrop-blur-xl border-t border-white/10 px-4 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                <motion.button
                                    ...
                                    className="w-full sm:w-auto px-6 sm:px-8 h-12 rounded-xl bg-gradient-to-r from-purple-600 to-fuchsia-500 text-[#0B1020] text-sm font-black uppercase tracking-widest flex items-center justify-center gap-3"
                                >
                    ...
                    <div className="grid grid-cols-3 gap-3 sm:gap-6">
                        {[
                            ...
                            <div key={i} className="p-3 sm:p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-purple-500/30 transition-all cursor-pointer group text-center flex flex-col items-center justify-center">
                                <item.icon className="w-5 h-5 sm:w-6 sm:h-6 mb-2 sm:mb-3 text-slate-400 group-hover:text-purple-400" />
                                <h3 className="text-[8px] sm:text-[10px] font-black text-white uppercase tracking-widest leading-tight">{item.label}</h3>
                            </div>
                        ))}
                    </div>
