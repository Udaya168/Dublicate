...
export function QuickEditProcessingScreen() {
    ...
    return (
        ...
        >
            ...
            {/* Main View */}
            <main className="flex-1 flex flex-col items-center justify-center relative z-10 p-4 sm:p-8 overflow-y-auto">
                        ...
                        <div className="space-y-3">
                            {steps.map((step, idx) => (
                                <motion.div
                                    ...
                                    className={`flex items-center gap-3 p-3 rounded-xl border transition-all ${idx === currentStep ? 'bg-purple-500/5 border-purple-500/20 shadow-[0_0_15px_rgba(168, 85, 247,0.1)]' : 'border-white/5 bg-transparent'
                                        }`}
                                >
